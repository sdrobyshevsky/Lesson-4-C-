...
// необходимые зависимости для работы с базой данных (например, Entity Framework Core). Затем вынесите все операции с базой данных из вашего проекта GraphQL-сервера в этот новый проект.


// Шаг 2: Создание докер-образа для базы данных

// Теперь создайте Dockerfile для вашего проекта базы данных.
// В Dockerfile укажите все необходимые шаги для сборки образа, включая установку зависимостей, 
